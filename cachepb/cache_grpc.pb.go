...
func (c *cacheServiceClient) Set(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
func (UnimplementedCacheServiceServer) Set(context.Context, *Request) (*Response, error) {
